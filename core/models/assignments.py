...
class Assignment(db.Model):
    ...
    def submit(cls, _id, teacher_id, principal: Principal):
        ...
        if assignment.state == AssignmentStateEnum.DRAFT:
            ...
            assertions.assert_valid(assignment.state != "DRAFT", 'only draft assignments can be submitted')
    ...
    def grade_(cls, _id, grade, principal: Principal):
        ...
        assertions.assert_valid(assignment.state == 'SUBMITTED', 'only submitted assignment can be graded')
        assertions.assert_valid(assignment.grade in GradeEnum, 'Grade is not valid')
